...
echo " 7. CONFIGURE X SERVER FOR RUNNING NATIVELY"
...
echo 'mount -o bind /storage '$mpath'/storage'>>/sdcard/boot.sh
...
echo 'echo "=>unmounting /storage"'>>/sdcard/boot.sh
echo 'umount '$mpath'/storage'>>/sdcard/boot.sh
